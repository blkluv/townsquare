...
function RewardClaimed({userId, setDisplayWeekly}: UserRewardProps) {
  ...
  return (
    <View style={styles.DiceRowCol}>
      {weeklyReward ? (
        <RewardClaimedImage userId={userId} rewardsImg={weeklyReward.image} />
      ) : dailyReward ? (
        <RewardClaimedImage userId={userId} rewardsImg={dailyReward.image} />
      ) : (
        <span>never</span>
      )}
...
function RewardClaimScreen({
  ...
  return (
    <View>
      {reward ? (
        <RewardClaimed userId={userId} setDisplayWeekly={setDisplayWeekly} />
      ) : (
        <View style={styles.DiceRowCol}>
          ...
          />
          <RewardClaimButton userId={userId} isWeekly={!!isWeekly} />
        </View>
      )}
    </View>
  )
